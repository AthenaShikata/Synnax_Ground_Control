...
If running on Linux, follow the instructions in this thread if having issues creating simulated NI hardware (Maybe real hardware too idk) https://forums.ni.com/t5/Multifunction-DAQ/Simulated-devices-on-Linux-stuck-in-quot-Initializing-quot/m-p/4460845. The files I used can be found in this commit https://github.com/AthenaShikata/Random/commit/f56400252777263474fe954fa66f4b5983e1cd06. Just add an entry to sudo crontab @reboot to run nidaqmx-import.sh.
If running on Linux, the shift detect functionality will not work because this program uses the Keyboard module. To use shift detect on linux, modify the program to work with the pynput module instead (a working example of this is in the [ValkyrieSpaceSystems/MIDGARD_Ground_Control](https://github.com/ValkyrieSpaceSystems/MIDGARD_Ground_Control) repo) or use the bypass_shift variable.
